...
public class SignUp extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("G Company");

        // Try to load the icon with multiple path attempts
        java.net.URL iconUrl = getClass().getResource("/Icon/logo.png");
        if (iconUrl == null) {
            iconUrl = getClass().getResource("../Icon/logo.png");
        }
        if (iconUrl == null) {
            iconUrl = getClass().getResource("/loginandsignup/Icon/logo.png");
        }
        
        if (iconUrl != null) {
            jLabel1.setIcon(new javax.swing.ImageIcon(iconUrl));
        } else {
            // If icon cannot be loaded, use text as fallback
            jLabel1.setText("G");
            jLabel1.setFont(new java.awt.Font("Segoe UI", java.awt.Font.PLAIN, 48));
            jLabel1.setForeground(java.awt.Color.WHITE);
        }

        jLabel3.setFont(new java.awt.Font("Segoe UI Light", 0, 14)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(204, 204, 204));
        jLabel3.setText("copyright © geodevelopment.xyz all rights reserved");
